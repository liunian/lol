...
const RAW_MATCH_DATA = [
    ...
    ['RW', 'OMG', '2021-03-07', '15:00', '0:2'], ['TT', 'BLG', '2021-03-07', '17:00', '0:2'], ['IG', 'TES', '2021-03-07', '19:00', '1:2'],

    ['V5', 'JDG', '2021-03-08', '17:00', '0:2'], ['RNG', 'ES', '2021-03-08', '19:00', '2:0'],
    ['FPX', 'LGD', '2021-03-09', '17:00', '2:0'], ['TES', 'BLG', '2021-03-09', '19:00', '2:0'],
    ['RA', 'V5', '2021-03-10', '17:00', '2:0'], ['SN', 'RW', '2021-03-10', '19:00', '2:0'],
    ['WE', 'OMG', '2021-03-11', '17:00', '2:1'], ['EDG', 'LNG', '2021-03-11', '19:00', '2:0'],
    ['ES', 'LGD', '2021-03-12', '17:00', '0:2'], ['FPX', 'TT', '2021-03-12', '19:00', '2:1'],
    ['BLG', 'RW', '2021-03-13', '15:00', '2:0'], ['RA', 'IG', '2021-03-13', '17:00', '2:0'], ['EDG', 'TES', '2021-03-13', '19:00', '1:2'],
    ['OMG', 'LNG', '2021-03-14', '15:00', '0:2'], ['SN', 'WE', '2021-03-14', '17:00', '0:2'], ['RNG', 'JDG', '2021-03-14', '19:00', '0:2'],

    ['LGD', 'RA', '2021-03-15', '17:00', '2:1'], ['TT', 'IG', '2021-03-15', '19:00', '0:2'],
    ['LGD', 'OMG', '2021-03-17', '17:00', '1:2'], ['V5', 'TES', '2021-03-17', '19:00', '0:2'],
    ['TT', 'RW', '2021-03-18', '17:00', '2:0'], ['WE', 'BLG', '2021-03-18', '19:00', '2:1'],
    ['EDG', 'ES', '2021-03-19', '17:00', '2:0'], ['LNG', 'JDG', '2021-03-19', '19:00', '0:2'],
    ['V5', 'FPX', '2021-03-20', '17:00', '2:0'], ['RNG', 'TES', '2021-03-20', '19:00', '2:0'],
    ['JDG', 'LGD', '2021-03-21', '17:00', '2:0'], ['LNG', 'SN', '2021-03-21', '19:00', '0:2'],


    ['RA', 'RNG', '2021-03-22', '17:00', '0:2'], ['IG', 'V5', '2021-03-22', '19:00', '2:1'],
    ['JDG', 'OMG', '2021-03-23', '17:00', '2:0'], ['SN', 'BLG', '2021-03-23', '19:00', '2:0'],
    ['TES', 'TT', '2021-03-24', '17:00', '2:0'], ['WE', 'EDG', '2021-03-24', '19:00', '0:2'],
    ['RW', 'LNG', '2021-03-25', '17:00', '0:2'], ['LGD', 'IG', '2021-03-25', '19:00', '0:2'],
